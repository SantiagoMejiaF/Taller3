...
import com.example.taller3.databinding.ActivityRegistroDatosVetBinding
...
class RegistroDatosVetActivity : AppCompatActivity() {
    private lateinit var binding: ActivityRegistroDatosVetBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRegistroDatosVetBinding.inflate(layoutInflater)
    ...
    private fun cargarUsuarioFireBase (){
        ...
        val nombreVeterinario = binding.etNombreUsuario.text.toString()
        val apellidoVeterinario = binding.etApellidoUsuario.text.toString()
        val identificacionVeterinario = binding.etIdentificacionUsuario.text.toString()
        val latitudVeterinario = binding.etLatitud.text.toString()
        val longitudVeterinario = binding.etLongitud.text.toString()
        val placaVeterinario = binding.etPlaca.text.toString()
        ...
        nuevoVeterinario["identificacion"] = identificacionVeterinario
        nuevoVeterinario["latitud"] = latitudVeterinario
        nuevoVeterinario["longitud"] = longitudVeterinario
        nuevoVeterinario["placa"] = placaVeterinario
